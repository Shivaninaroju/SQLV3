...
import { FiDatabase, FiMail, FiLock, FiUser, FiUserPlus, FiEye, FiEyeOff } from 'react-icons/fi';
import { getAuthErrorMessage, getAuthValidationDetails } from '../utils/authErrors';
...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!/^[a-zA-Z0-9_-]+$/.test(trimmedUsername)) {
      toast.error('Username may only contain letters, numbers, underscores, and hyphens');
      return;
    }
    ...
    try {
      ...
      const details = getAuthValidationDetails(error);
      if (details.length > 0) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Start collaborating on databases today</p>
        </div>
